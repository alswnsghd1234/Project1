...
conn = sqlite3.connect(
    'C:/Users/min/OneDrive/바탕 화면/My_developed/Project_BE/Project_Test_Folder/DB_MGMT/database.db')  # 본인 DB 파일 경로
...
with conn:
    with open('C:/Users/min/OneDrive/바탕 화면/My_developed/Project_BE/Project_Test_Folder/DB_MGMT/dump.sql', 'w') as f:
